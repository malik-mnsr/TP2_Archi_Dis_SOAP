...
public class Application {
    public static void main(String[] args) throws ClassNotFoundException {
        String SERVICE1_URI =
                "http://localhost:8082/ServerAccor/Availability"; // URI du service
        String SERVICE2_URI =
                "http://localhost:8082/ServerAccor/Reservation";
        // Publication du service web
        Endpoint.publish(SERVICE1_URI, new HotelServiceAvailabilityImpl(3));
        System.err.println("Web Service 1 successfully published at: " +
                SERVICE1_URI);

        Endpoint.publish(SERVICE2_URI, new HotelServiceReservationImpl(3));
