...
public class Application {
    public static void main(String[] args) throws ClassNotFoundException {
        String SERVICE1_URI =
                "http://localhost:8081/ServerMarriot/Availability"; // URI du service
        String SERVICE2_URI =
                "http://localhost:8081/ServerMarriot/Reservation";
        // Publication du service web
        Endpoint.publish(SERVICE1_URI, new HotelServiceAvailabilityImpl(2));
        System.err.println("Web Service 1 successfully published at: " +
                SERVICE1_URI);

        Endpoint.publish(SERVICE2_URI, new HotelServiceReservationImpl(2));
